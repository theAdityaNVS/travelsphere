...
3.  **Initialization Pattern**:
    -   Implemented a `Proxy` in `src/lib/firebase/admin.ts`.
    -   This ensures that the database is only accessed if properly initialized, providing better error messages during development.
4.  **Data Modeling**:
